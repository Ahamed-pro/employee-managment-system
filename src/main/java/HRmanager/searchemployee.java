...
/**
 * Search Employee screen – professional dark UI.
 */
public class searchemployee extends JFrame {
    ...
    private void initUI() {
        setTitle("HR Portal — Search Employee");
        ...
        txtsearch.setToolTipText("Search by name, department, ID or designation");
        ...
        footRow.add(UITheme.createBadge("HR Manager"), BorderLayout.WEST);

        JButton btnClear = UITheme.createSecondaryButton("Clear");
        btnClear.setPreferredSize(new Dimension(90, 32));
        btnClear.addActionListener(e -> { tableModel.setRowCount(0); txtsearch.setText(""); lblCount.setText("  Enter a search term to find employees"); });
